...
const Prontuario = () => {
  ...
  return (
    <div className="prontuario-container-main">
      <Sidebar />
      <div className="prontuario-content-wrapper">
        <NotificationHeader />
          ...
          <div className="prontuario-layout">
            <div className="patient-list-card">
              ...
              {pacientes.map((paciente, index) => (
                <div key={index} className={`patient-item ${paciente.selected ? 'selected' : ''}`}>
                  <h3>{paciente.nome}</h3>
                  <p>{paciente.cpf}</p>
                </div>
              ))}
            ...
            <div className="prontuario-details-card">
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <textarea className="form-textarea" placeholder="Descreva as observações da consulta..."></textarea>
                </div>
                <div className="form-group">
                ...
                <div className="prontuario-footer-actions">
                  ...
                  <button type="submit" className="save-btn">Salvar Prontuário</button>
                </div>
              </form>
            </div>
          </div>
